...
public interface IEntry<V> {
    ...
    /**
     Determines whether the entry should be saved.
     This method can be overridden to specify custom save behavior.

     @return True if the entry should be saved, false otherwise. */
